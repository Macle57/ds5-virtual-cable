...
const GESTURES: Record<string, React.ReactNode> = {
  ...
  touch_slide_up: <><path d="M0 12 v-22 M0 -10 l-5 5 M0 -10 l5 5" />{dot(-8, 9)}{dot(8, 9)}</>,
  touch_slide_down: <><path d="M0 -12 v22 M0 10 l-5 -5 M0 10 l5 -5" />{dot(-8, -9)}{dot(8, -9)}</>,
  touch_slide_left: <><path d="M12 0 h-22 M-10 0 l5 -5 M-10 0 l5 5" />{dot(9, -8)}{dot(9, 8)}</>,
  touch_slide_right: <><path d="M-12 0 h22 M10 0 l-5 -5 M10 0 l-5 5" />{dot(-9, -8)}{dot(-9, 8)}</>,
